...
| Shipped bytes | 17:00:05, a third boot on the release build (md5 `7bd20ab0eae86cfe9dc3e4d585dd6d0a`, 275,968 bytes, a clean build of the merge commit `86dc540`, byte-identical on a second clean build): `Loading [TheRavensCall 1.6.1]`, awakens, Chronicle opens, `World census: 262520 objects in 20 ms.`, zero warnings, graceful stop with 2 of the 3 shutdown lines (the session-summary row missed, the destruction-order race known since 1.4.0). This build stays staged on Storm10 |
